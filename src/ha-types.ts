// This file is a straight copy from https://github.com/home-assistant/frontend/tree/dev/src/types.ts
// with the local imports and subsequent usage commented out. This is far from ideal but I have not
// found an npm package that is up to date with this information.
// Copy date: 14 May 2024.
import {
  Auth,
  Connection,
  HassConfig,
